...
public class KarloController {
    ...
    public ModelAndView processKarloRequest() {
        ...
        String[] names = {"고양이", "개", "사자", "호랑이", "곰", "코끼리", "기린", "원숭이", "판다", "양", "침팬지", "뱀", "캥거루", "얼룩말", "고릴라", "오랑우탄", "악어", "펭귄", "파랑새", "사슴", "돌고래", "치타", "물범", "순록", "산", "바다", "호수", "하늘", "폭포", "초원", "섬", "해변", "숲", "바람", "구름", "달", "별", "태양", "무지개", "얼음", "바람력", "사막", "벌판", "축구", "농구", "야구", "수영", "달리기", "테니스", "골프", "볼링", "요가", "등산", "배드민턴", "체조", "스케이팅", "헬스", "승마", "서핑", "스노우보드", "클라이밍", "스쿼시", "자전거 타기" };
        ...
        String REST_API_KEY = "d35a1a145ffe5d773d19f283010f55d6";

        Map<String, Object> jsonMap = new HashMap<>();
        jsonMap.put("prompt", String.join(" ", translations));
        jsonMap.put("samples", 1);
        jsonMap.put("return_type", "base64_string");
        jsonMap.put("nsfw_checker", true);
